#########################################################
#
# PI E-872 MATLAB MoveSample Version 1.5.0
#
...
# Description:
#
# This sample loads the MATLAB driver and connects a E-872 controller using the connection dialog.
# It shows the connected actuator and moves two axes of the actuator.
#
#########################################################
#
