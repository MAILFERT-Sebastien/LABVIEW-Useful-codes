...
%   a actuator is connected in which no absolute sensor is installed. Other actuators don't know the FRF command .
%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Please note that the referencing process for the E-712 Controller can only be performed if
% a stage is connected in which no absolute sensor is installed. Other stages don't know the FRF command

controllerReferenceSettings = 'Common'; % 'Common' 'C-887' 'E-712'
switch controllerReferenceSettings
    case 'Common'
        axis = '1';
        servoMode = 1;
    case 'C-887'
...
try
    ...
    %% Startup stage
    PIdevice.SVO ( axis, servoMode );

    %% Start referencing

    PIdevice.FRF ( axis );  % find reference (for E-712: only working with stages in which no absolute sensor is installed)                     
